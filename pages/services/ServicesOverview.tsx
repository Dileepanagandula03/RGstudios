...
import { ArrowRight, CheckCircle2, Sparkles, Facebook, Instagram, Linkedin } from 'lucide-react';
            ...
            <div key={service.id} className={`flex flex-col ${index % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-16 items-center`}>
              <div className="lg:w-1/2">
                <div className="relative">
                  <div className="w-full aspect-video bg-white rounded-[50px] shadow-xl overflow-hidden group">
                    <img 
                      src={service.image} 
                      alt={service.title}
                    ...
                    {service.id === 'social-media-marketing' && (
                      <div className="absolute bottom-6 left-0 right-0 flex justify-center gap-4 z-20">
                        <div className="w-10 h-10 bg-white/10 backdrop-blur-xl rounded-xl text-white border border-white/20 shadow-2xl flex items-center justify-center transform hover:scale-110 transition-transform">
                          <Instagram size={18} />
                        </div>
                        <div className="w-10 h-10 bg-white/10 backdrop-blur-xl rounded-xl text-white border border-white/20 shadow-2xl flex items-center justify-center transform hover:scale-110 transition-transform">
                          <Linkedin size={18} />
