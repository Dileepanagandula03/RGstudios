...
const Home: React.FC = () => {
  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative h-[100vh] flex items-center justify-center overflow-hidden bg-white">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center flex flex-col items-center">
          <div className="max-w-5xl">
            <span className="block text-gray-600 text-[11px] uppercase tracking-[12px] font-black mb-6">2026 Edition</span>
      ...
      <section className="py-32 relative overflow-hidden bg-[#FFFBF0]">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-24">
            ...
            <h2 className="text-4xl md:text-6xl font-bold text-[#2D3134]">Six Core Services.</h2>
      ...
      {/* BLOCK 5: CTA */}
      <section className="py-20 relative overflow-hidden bg-[#F7F6F2] border-t border-gray-100">
        <div className="container mx-auto px-6 text-center max-w-2xl relative z-10">
           <div className="flex justify-center mb-6">
              <Heart size={24} fill="#E91E63" className="text-[#E91E63] animate-float" />
           </div>
           <h2 className="text-3xl md:text-5xl font-bold text-[#2D3134] mb-8 italic leading-tight tracking-tighter">
             Let’s build something <br /> <span className="text-[#E91E63]">that lasts.</span>
           </h2>
           <div className="text-[#2D3134] mb-10 max-w-lg mx-auto font-semibold leading-relaxed text-sm">
             <p>We partner with founders, creators, and brands who care about depth, clarity, <br /> and intentional growth.</p>
           </div>
           <Link to="/contact" className="group relative inline-flex items-center gap-4 bg-[#2D3134] text-white px-12 py-5 rounded-full text-[10px] uppercase font-black tracking-[4px] shadow-xl hover:bg-[#E91E63] transition-all hover:scale-105 active:scale-95">
             Start a conversation <ArrowRight size={14} className="group-hover:translate-x-2 transition-transform" />
           </Link>
           <div className="mt-12 flex flex-col items-center">
              <span className="text-[9px] uppercase tracking-[4px] font-black text-[#E91E63]/50">
