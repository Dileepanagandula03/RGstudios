...
const CASE_STUDY_DATA: Record<string, any> = {
  ...
  'dnk-balloon-installations': {
    title: 'Visual Virality',
    subtitle: 'DNK Balloon Installations',
    tagline: 'Leveraging visual virality to build demand acceleration systems.',
    client: 'DNK Glam Events',
    techCycle: 'Experiential Growth',
    ...
    content: [
      {
        ...
        image: 'https://images.unsplash.com/photo-1574391884720-bbc37bb05d3c?auto=format&fit=crop&q=80&w=800'
      },
      {
        type: 'section',
        title: 'THE CHALLENGE',
  ...
  'dnk-social-celebrations': {
    title: 'Demand Engine',
    subtitle: 'DNK Social & Special Celebrations',
    tagline: 'Designing a recurring micro-event demand engine.',
    client: 'DNK Glam Events',
    techCycle: 'Recurring Acquisition',
    timeline: 'Ongoing Partnership',
