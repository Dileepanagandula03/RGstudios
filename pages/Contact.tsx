                ...
                {status === 'success' ? (
                  ...
                  <form className="space-y-5 relative z-10" onSubmit={handleSubmit}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                      ...
                      <div className="space-y-1 group">
                        <label className="text-[7px] font-black uppercase tracking-[4px] text-gray-600 ml-1 group-focus-within:text-pink-500 transition-colors">Services</label>
                        <div className="relative">
                          <select 
                            required
                          ...
                          <div className="absolute right-1 bottom-2 pointer-events-none text-gray-400">
                            <ChevronDown size={14} />
                          </div>
                        </div>
                      </div>
